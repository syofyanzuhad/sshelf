                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
                        <div class="col-span-2 lg:col-span-2">
                            ...
                            @if(config('sshelf.mode') === 'saas')
                                <div class="mb-6">
                                    <a href="https://smollaunch.com" target="_blank" rel="noopener" class="dark:hidden opacity-80 hover:opacity-100 transition">
                                        <img src="https://smollaunch.com/badges/featured.svg" alt="Featured on Smol Launch" loading="lazy" width="180" height="44" />
                                    </a>
                                    <a href="https://smollaunch.com" target="_blank" rel="noopener" class="hidden dark:block opacity-80 hover:opacity-100 transition">
                                        <img src="https://smollaunch.com/badges/featured-dark.svg" alt="Featured on Smol Launch" loading="lazy" width="180" height="44" />
                                    </a>
                                </div>
                            @endif
