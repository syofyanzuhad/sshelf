<nav x-data="{}" class="relative z-20 w-full">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex justify-between items-center">
        ...
        <div class="hidden lg:flex items-center space-x-8">
            ...
            <a href="{{ url('/#pricing') }}" class="text-[10px] font-bold text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition uppercase tracking-[0.2em]">Pricing</a>
